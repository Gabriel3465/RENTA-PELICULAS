...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        // Logo
        JLabel logo = new JLabel(new ImageIcon(getClass().getResource("/images/Play.png")));
        logo.setPreferredSize(new Dimension(1000,1000)); // Aseguramos que el logo tenga un tamaño adecuado
